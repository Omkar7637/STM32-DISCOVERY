...
void uart_send(void);
void uart_send_data_2(void);
void uart_send_data_3(void);
void uart_send_data_4(void);
...
void uart_send(void)
{
    printf("uart sending data [1]...\n\r");
}

void uart_send_data_2(void)
{
    printf("uart sending data [2]...\n\r");
}

void uart_send_data_3(void)
{
    printf("uart sending data [3]...\n\r");
}

void uart_send_data_4(void)
{
    printf("uart sending data [4]...\n\r");
}
